...
import { OrganizationToolbar } from '../../../../app/modules/masters/organization/components/header/OrganizationToolbar'
import { VendorToolbar } from '../../../../app/modules/vendors/components/VendorToolbar'
import { AttendanceToolbar } from '../../../../app/modules/attendance/components/view/AttendanceToolbar'
import { DashboardToolbar } from '../../../../app/modules/dashboard/DashboardToolbar'
import { CourtsTollbar } from '../../../../app/modules/Courts/columns/view/CourtsTollbar'
import HeroSliderToolbar from '../../../../app/modules/HeroSlider/columns/view/HeroSliderToolbar'

import AllStudentTollbar from '../../../../app/modules/Students/columns/view/AllStudentTollbar'
...
const Toolbar = () => {
  ...
  switch (config.app?.toolbar?.layout) {
    ...
    case 'student':
      return <AllStudentTollbar/>

    case 'attendance':
      return <AttendanceToolbar />
  
    case 'courts':
      return <CourtsTollbar />

     
    case 'herosliders':
     return <HeroSliderToolbar />
    case 'allbus':
     return <HeroSliderToolbar />
    case 'allstaff':
     return <HeroSliderToolbar />
    case 'vendors':
      return <VendorToolbar />
    case 'organization':
