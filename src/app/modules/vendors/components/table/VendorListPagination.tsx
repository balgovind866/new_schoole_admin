...
const VendorListPagination = () => {

    const pagination = useQueryResponsePagination()
    const isLoading = useQueryResponseLoading()
    const { updateState } = useVendorQueryRequest()  // Use the staff-specific query request provider
    ...
    return(
         <div className='row'>
                    ...
                    <div className='col-sm-12 col-md-7 d-flex align-items-center justify-content-center justify-content-md-end'>
                        <div id='kt_table_staff_paginate'>  {/* Update to staff-specific paginate ID */}
